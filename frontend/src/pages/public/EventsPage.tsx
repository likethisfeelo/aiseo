      ...
      <section className="persona" style={{ paddingTop: 80, paddingBottom: 100 }}>
        <div className="section-inner">
          <div className="persona-header">
            ...
            <h2 className="section-h2">이벤트</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 20, marginTop: 56 }}>
            {[
              {
                tag: '진행중', tagColor: '#059669', tagBg: '#D1FAE5',
                title: '얼리버드 수강 할인',
              ...
              {
                tag: '예정', tagColor: '#D97706', tagBg: '#FEF3C7',
                title: 'AI SEO 무료 웨비나',
              ...
              <div key={event.title} style={{
                ...
                {/* Top accent bar */}
                <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 4, background: event.accent }}></div>
                <span style={{
                ...
                <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.75, marginBottom: 20, flex: 1 }}>
                  {event.desc}
                </p>
