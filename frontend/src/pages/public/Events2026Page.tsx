      ...
      <main className="evtmain">
        ...
        <section className="events-list" id="events-list">
          <div className="events-list-inner">
            ...
            {/* EVENT 05 — 사진스냅 작가 특별 (10만원) */}
            <a href="/events2026/snap" className="event-card">
              <div className="event-card-head">
                <span className="event-card-status">진행 중</span>
                <span className="event-card-date">스냅 작가 · 스튜디오 한정</span>
              </div>

              <div className="event-card-tag-row">
                <span className="event-card-num">EVENT 05</span>
                <span className="event-card-tag">SPECIAL · 사진스냅 작가</span>
              </div>

              <h3 className="event-card-h">
                스냅 작가님,<br />50만원 패키지를 10만원에
              </h3>
              <p className="event-card-sub">
                웨딩 · 가족 · 프로필 · 반려동물 스냅 작가 한정. 첫완성패키지의 본세션 3회(검색 전략 ·
                콘텐츠 기획 · 즉시 배포)를 특별가로, 회원가입 없이 희망 교육 시간만 등록하면 카카오톡으로 연락드립니다.
              </p>
            ...
            {/* EVENT 06 — 반려동물 서비스 특별 (10만원) */}
            <a href="/events2026/pet" className="event-card">
              <div className="event-card-head">
                <span className="event-card-status">진행 중</span>
                <span className="event-card-date">반려동물 서비스업 한정</span>
              </div>

              <div className="event-card-tag-row">
                <span className="event-card-num">EVENT 06</span>
                <span className="event-card-tag">SPECIAL · 반려동물 서비스</span>
              </div>

              <h3 className="event-card-h">
                반려동물 서비스 사장님,<br />50만원 패키지를 10만원에
              </h3>
              <p className="event-card-sub">
                펫 미용 · 호텔 · 유치원 · 카페 · 용품샵 · 펫시터 한정. 첫완성패키지의 본세션 3회(검색 전략 ·
                콘텐츠 기획 · 즉시 배포)를 특별가로, 회원가입 없이 희망 교육 시간만 등록하면 카카오톡으로 연락드립니다.
              </p>
